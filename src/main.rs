...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app = Router::new()
        ...
        .route("/api/script-parameter-types", routing::get(get_script_parameter_types))
    ...
    let listener = tokio::net::TcpListener::bind("0.0.0.0:3000").await.map_err(|e| e.to_string())?;
